...
- **XGBoost_tutorial**  To improve the cWB detection efficiency a machine learning algorithm, we use a decision tree classifier (XGBoost) to distingish between potential GW signals and noise [3,4]. This notebook shows how to train the classifier using cWB triggers, and apply it to cWB.
...
3. Tanmaya Mishra et al. “Optimization of model independent gravitational wave search for binary black hole mergers using machine learning”. In: Physical Review D 104.2 (2021),
p. 023014.
4. Marek J. Szczepańczyk et al. “Search for gravitational-wave bursts in the third Advanced LIGO-Virgo run with coherent WaveBurst enhanced by machine learning”. In: Phys.
